...
{
    public class CreateDatPhongValidation : AbstractValidator<DatPhongVM>
    {
        public CreateDatPhongValidation() 
        {
            ...
            RuleFor(x => x.BookingDate)
                .GreaterThanOrEqualTo(DateTime.Today).WithMessage("Ngày đặt phòng phải lớn hơn hoặc bằng nagfy hiện tại.");

            RuleFor(x => x.Status)
                .NotEmpty().WithMessage("Trạng thái ko được để trống")
